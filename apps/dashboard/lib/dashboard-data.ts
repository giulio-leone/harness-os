...
export interface DashboardEnvironment {
  ...
  HARNESS_DASHBOARD_CLAIM_AGENT_ID?: string;
  HARNESS_DASHBOARD_CLAIM_HOST?: string;
  HARNESS_DASHBOARD_HOST_CAPABILITIES?: string;
  HARNESS_DASHBOARD_LEASE_TTL_SECONDS?: string;
  HARNESS_DASHBOARD_WORKLOAD_CLASSES?: string;
}
...
export function readDashboardEnvironment(): DashboardEnvironment {
  return {
    ...
    HARNESS_DASHBOARD_CLAIM_AGENT_ID: process.env.HARNESS_DASHBOARD_CLAIM_AGENT_ID,
    HARNESS_DASHBOARD_CLAIM_HOST: process.env.HARNESS_DASHBOARD_CLAIM_HOST,
    HARNESS_DASHBOARD_HOST_CAPABILITIES:
      process.env.HARNESS_DASHBOARD_HOST_CAPABILITIES,
    HARNESS_DASHBOARD_LEASE_TTL_SECONDS:
      process.env.HARNESS_DASHBOARD_LEASE_TTL_SECONDS,
    HARNESS_DASHBOARD_WORKLOAD_CLASSES:
      process.env.HARNESS_DASHBOARD_WORKLOAD_CLASSES,
  };
}
